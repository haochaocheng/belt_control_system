...
.SYNOPSIS
    下载所有TTS引擎模型（统一脚本）
.DESCRIPTION
    按优先级顺序下载MeloTTS、Piper TTS、Coqui TTS三个引擎的模型
.EXAMPLE
    .\19-download-all-tts-models.ps1
.NOTES
    2026-02-15 16:00: 创建 - 统一下载所有TTS模型
#>
...
Write-Host "  下载所有TTS引擎模型" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  📋 计划下载:" -ForegroundColor Cyan
Write-Host "     1. MeloTTS（首选引擎，50-100 MB）" -ForegroundColor Gray
Write-Host "     2. Piper TTS（性能引擎，10-50 MB）" -ForegroundColor Gray
Write-Host "     3. Coqui TTS（功能引擎，100-200 MB）" -ForegroundColor Gray
Write-Host ""
Write-Host "  ⏳ 预计总时间: 30-60分钟" -ForegroundColor Yellow
Write-Host ""
...
# ============================================================
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  [1/3] 下载MeloTTS模型" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$meloScript = Join-Path $ScriptDir "16-download-melotts-models.ps1"
...
# ============================================================
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  [2/3] 下载Piper TTS模型" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$coquiScript = Join-Path $ScriptDir "18-download-coqui-models.ps1"
...
Write-Host ""
Write-Host "🚀 下一步: 测试所有TTS引擎" -ForegroundColor Yellow
Write-Host ""
