# Generic Smart Copy - only copy changed files
# Usage: cmake -DSOURCE_DIR=<src> -DDEST_DIR=<dst> -DLABEL=<label> -P smart_copy.cmake
#
# This script compares source and destination files and only copies when:
# 1. File doesn't exist in destination
# 2. File timestamp is newer in source
# 3. File size is different (fallback if timestamp unavailable)
