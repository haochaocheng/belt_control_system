            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [MotorTempTab] 鼠标点击动作保护类型，发射信号: requestFocusParamIndex(2)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [MotorTempTab] 鼠标点击故障保护类型，发射信号: requestFocusParamIndex(3)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [MotorTempTab] 鼠标点击温度量程，发射信号: requestFocusParamIndex(4)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [MotorTempTab] 鼠标点击温度上限，发射信号: requestFocusParamIndex(5)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [MotorTempTab] 鼠标点击温度下限，发射信号: requestFocusParamIndex(6)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [MotorTempTab] 鼠标点击输入点选择，发射信号: requestFocusParamIndex(7)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [MotorTempTab] 鼠标点击过滤干扰延时，发射信号: requestFocusParamIndex(8)")
