...
Rectangle {
        ...
        GridLayout {
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击是否投入，发射信号: requestFocusParamIndex(0)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    enabled: root.playModeSelection === 0  // 按次数时启用，否则禁用
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击次数设置，发射信号: requestFocusParamIndex(2)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    enabled: root.playModeSelection === 1  // 按时间时启用，否则禁用
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击时间设置，发射信号: requestFocusParamIndex(3)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击动作保护类型，发射信号: requestFocusParamIndex(4)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击故障保护类型，发射信号: requestFocusParamIndex(5)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击温度量程，发射信号: requestFocusParamIndex(6)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击温度上限，发射信号: requestFocusParamIndex(7)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击温度下限，发射信号: requestFocusParamIndex(8)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击输入点选择，发射信号: requestFocusParamIndex(9)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [MotorTempTab] 鼠标点击过滤干扰延时，发射信号: requestFocusParamIndex(10)")
    ...
    function triggerParamInput(paramIndex) {
        ...
        case 1:  // 播放方式（Cyberpunk切换按钮）
            console.log("✅ [MotorTempTab] 切换播放方式")
        ...
        case 5:  // 故障保护类型（CustomComboBox）
            console.log("✅ [MotorTempTab] 故障保护类型")
            // ComboBox 不需要虚拟键盘，直接切换选项
        ...
        // 激活虚拟键盘
        if (inputField) {
            console.log("✅ [MotorTempTab] 激活虚拟键盘 - 控件:", inputField)
