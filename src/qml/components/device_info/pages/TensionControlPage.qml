    ...
    DeviceInfo.NavigationManager {
        ...
        function moveInParamArea(direction) {
            ...
            if (root.currentControlIndex === 0) {
                // 张力传感器: 16个参数（4列布局，每行2个参数）
                // ✅ 2026-03-22 [Phase 7.48.76]: 新增音频来源(12)和播放方式(13)
                ...
                // Row8: 洒水编号(15)
                rows = [[0,2],[2,2],[4,2],[6,2],[8,2],[10,2],[12,2],[14,1],[15,1]]
            } else {
        ...
        function moveInButtonArea(direction) {
            ...
            case "Up":
                ...
                // ✅ 2026-03-22 [Phase 7.48.76]: 张力传感器新增音频来源+播放方式后，最后索引14→15
                paramIndex = (root.currentControlIndex === 0) ? 15 : 8
                return
            }
