...
Rectangle {
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [XAxisVibrationTab] 鼠标点击报警类型，发射信号: requestFocusParamIndex(1)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [XAxisVibrationTab] 鼠标点击动作保护类型，发射信号: requestFocusParamIndex(2)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [XAxisVibrationTab] 鼠标点击故障保护类型，发射信号: requestFocusParamIndex(3)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [XAxisVibrationTab] 鼠标点击振动量程，发射信号: requestFocusParamIndex(4)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [XAxisVibrationTab] 鼠标点击振动上限，发射信号: requestFocusParamIndex(5)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [XAxisVibrationTab] 鼠标点击振动下限，发射信号: requestFocusParamIndex(6)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [XAxisVibrationTab] 鼠标点击输入点选择，发射信号: requestFocusParamIndex(7)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [XAxisVibrationTab] 鼠标点击过滤干扰延时，发射信号: requestFocusParamIndex(8)")
    ...
    function triggerParamInput(paramIndex) {
        ...
        case 3:  // 故障保护类型（只读）
            ...
            break
        case 4:  // 振动量程（只读）
            console.log("✅ [XAxisVibrationTab] 振动量程（只读）")
            break
        case 5:  // 振动上限（只读）
            console.log("✅ [XAxisVibrationTab] 振动上限（只读）")
            break
        case 6:  // 振动下限（只读）
            console.log("✅ [XAxisVibrationTab] 振动下限（只读）")
            break
        case 7:  // 输入点选择（只读）
