...
// �?2026-01-25 [前轴承温度保护] 前轴承温度保护配�?// �?2026-01-28 [FIX 100.300.83] 替换所有只读显示框�?CustomReadOnlyField
// �?2026-01-30 [FIX 100.300.106]: 添加导航系统
// �?2026-01-30 [FIX 100.300.106.5]: 改为两列布局,参�?BasicConfigTab
// �?2026-01-30 [FIX 100.300.107.3]: 增加标签宽度�?120 �?160，确保长标签完整显示
Rectangle {
    id: root
    color: "transparent"
                ...
                ColumnLayout {
                    ...
                    // 是否投入（索�?0�?                    RowLayout {
                        ...
                        Text {
                            ...
                            color: "#9E9E9E"
                            Layout.preferredWidth: 160  // �?2026-01-30 [FIX 100.300.107.3]: �?120 增加�?160
