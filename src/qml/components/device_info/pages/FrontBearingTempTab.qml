        ...
        GridLayout {
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [FrontBearingTempTab] 鼠标点击报警类型，发射信号: requestFocusParamIndex(1)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    enabled: alarmTypeField.currentIndex === 1  // 按时间时启用，否则禁用
                    onClicked: function(mouse) {
                        console.log("✅ [FrontBearingTempTab] 鼠标点击时间设置，发射信号: requestFocusParamIndex(3)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [FrontBearingTempTab] 鼠标点击动作保护类型，发射信号: requestFocusParamIndex(4)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [FrontBearingTempTab] 鼠标点击故障保护类型，发射信号: requestFocusParamIndex(5)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [FrontBearingTempTab] 鼠标点击温度量程，发射信号: requestFocusParamIndex(6)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [FrontBearingTempTab] 鼠标点击温度下限，发射信号: requestFocusParamIndex(8)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [FrontBearingTempTab] 鼠标点击输入点选择，发射信号: requestFocusParamIndex(9)")
            ...
            Item {
                ...
                MouseArea {
                    anchors.fill: parent
                    onClicked: function(mouse) {
                        console.log("✅ [FrontBearingTempTab] 鼠标点击过滤干扰延时，发射信号: requestFocusParamIndex(10)")
