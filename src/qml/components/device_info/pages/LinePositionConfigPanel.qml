            ...
            Item { Layout.column: 3; Layout.row: 4; Layout.fillWidth: true; Layout.maximumWidth: 300; implicitHeight: 50
                RowLayout { anchors.fill: parent; spacing: 8
                    Button { id: playModeCountBtn; text: "按次数"; Layout.fillWidth: true; Layout.preferredHeight: 50; checkable: true; checked: root.playModeSelection === 0
                        ...
                        contentItem: Item { Row { anchors.centerIn: parent; spacing: 8; Rectangle { width: 8; height: 8; radius: 4; anchors.verticalCenter: parent.verticalCenter; color: playModeCountBtn.checked ? "#00d4ff" : "#475569"; Rectangle { width: 4; height: 4; radius: 2; anchors.centerIn: parent; color: playModeCountBtn.checked ? "#e0f7ff" : "#64748B" } }; Text { text: playModeCountBtn.text; font.pixelSize: 16; font.weight: playModeCountBtn.checked ? Font.Medium : Font.Normal; color: playModeCountBtn.checked ? "#00d4ff" : "#9E9E9E"; verticalAlignment: Text.AlignVCenter } } }
                    ...
                    Button { id: playModeDurationBtn; text: "按时长"; Layout.fillWidth: true; Layout.preferredHeight: 50; checkable: true; checked: root.playModeSelection === 1
                        ...
                        contentItem: Item { Row { anchors.centerIn: parent; spacing: 8; Rectangle { width: 8; height: 8; radius: 4; anchors.verticalCenter: parent.verticalCenter; color: playModeDurationBtn.checked ? "#F59E0B" : "#475569"; Rectangle { width: 4; height: 4; radius: 2; anchors.centerIn: parent; color: playModeDurationBtn.checked ? "#FDE68A" : "#64748B" } }; Text { text: playModeDurationBtn.text; font.pixelSize: 16; font.weight: playModeDurationBtn.checked ? Font.Medium : Font.Normal; color: playModeDurationBtn.checked ? "#F59E0B" : "#9E9E9E"; verticalAlignment: Text.AlignVCenter } } }
            ...
            Item { Layout.column: 1; Layout.row: 7; Layout.columnSpan: 3; Layout.fillWidth: true; Layout.maximumWidth: 300; implicitHeight: 50
                RowLayout { anchors.fill: parent; spacing: 8
                    Button { id: audioDefaultBtn; text: "默认"; Layout.fillWidth: true; Layout.preferredHeight: 50; checkable: true; checked: root.audioSourceMode === 0
                        ...
                        contentItem: Item { Row { anchors.centerIn: parent; spacing: 8; Rectangle { width: 8; height: 8; radius: 4; anchors.verticalCenter: parent.verticalCenter; color: audioDefaultBtn.checked ? "#00d4ff" : "#475569"; Rectangle { width: 4; height: 4; radius: 2; anchors.centerIn: parent; color: audioDefaultBtn.checked ? "#e0f7ff" : "#64748B" } }; Text { text: audioDefaultBtn.text; font.pixelSize: 16; font.weight: audioDefaultBtn.checked ? Font.Medium : Font.Normal; color: audioDefaultBtn.checked ? "#00d4ff" : "#9E9E9E"; verticalAlignment: Text.AlignVCenter } } }
                    ...
                    Button { id: audioTtsBtn; text: "TTS"; Layout.fillWidth: true; Layout.preferredHeight: 50; checkable: true; checked: root.audioSourceMode === 1
                        ...
                        contentItem: Item { Row { anchors.centerIn: parent; spacing: 8; Rectangle { width: 8; height: 8; radius: 4; anchors.verticalCenter: parent.verticalCenter; color: audioTtsBtn.checked ? "#F59E0B" : "#475569"; Rectangle { width: 4; height: 4; radius: 2; anchors.centerIn: parent; color: audioTtsBtn.checked ? "#FDE68A" : "#64748B" } }; Text { text: audioTtsBtn.text; font.pixelSize: 16; font.weight: audioTtsBtn.checked ? Font.Medium : Font.Normal; color: audioTtsBtn.checked ? "#F59E0B" : "#9E9E9E"; verticalAlignment: Text.AlignVCenter } } }
