...
Rectangle {
    ...
    function handleDataViewKey(direction) {
        ...
        case "Left":
        case "Right":
            root.pollDbNumber = root.pollDbNumber === 1 ? 2 : 1
            return true
        case "Down":
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            border.color: root.focusSubArea === 2 && root.focusParamIndex >= 0 && root.pollDbNumber === modelData.dbNum ? "#FF9800" : (root.pollDbNumber === modelData.dbNum ? "#64B5F6" : "#4a5068")
                            border.width: root.focusSubArea === 2 && root.focusParamIndex >= 0 && root.pollDbNumber === modelData.dbNum ? 3 : 1
