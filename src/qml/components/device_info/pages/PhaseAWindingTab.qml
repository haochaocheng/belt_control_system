...
// ✅ 2026-01-25 [A相绕组温度保护] A相绕组温度保护配置
...
Rectangle {
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [PhaseAWindingTab] 鼠标点击动作保护类型，发射信号: requestFocusParamIndex(2)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [PhaseAWindingTab] 鼠标点击故障保护类型，发射信号: requestFocusParamIndex(3)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [PhaseAWindingTab] 鼠标点击温度量程，发射信号: requestFocusParamIndex(4)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [PhaseAWindingTab] 鼠标点击温度上限，发射信号: requestFocusParamIndex(5)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [PhaseAWindingTab] 鼠标点击温度下限，发射信号: requestFocusParamIndex(6)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [PhaseAWindingTab] 鼠标点击输入点选择，发射信号: requestFocusParamIndex(7)")
            ...
            Item {
                ...
                MouseArea {
                    ...
                    onClicked: function(mouse) {
                        ...
                        console.log("✅ [PhaseAWindingTab] 鼠标点击过滤干扰延时，发射信号: requestFocusParamIndex(8)")
    ...
    function triggerParamInput(paramIndex) {
        ...
        case 1:  // 报警类型（RadioButton 组）
            ...
            break
        case 2:  // 动作保护类型（只读）
            console.log("✅ [PhaseAWindingTab] 动作保护类型（只读）")
            break
        case 3:  // 故障保护类型（只读）
            console.log("✅ [PhaseAWindingTab] 故障保护类型（只读）")
            break
        case 4:  // 温度量程（只读）
            console.log("✅ [PhaseAWindingTab] 温度量程（只读）")
            break
        case 5:  // 温度上限（只读）
            console.log("✅ [PhaseAWindingTab] 温度上限（只读）")
            break
        case 6:  // 温度下限（只读）
            console.log("✅ [PhaseAWindingTab] 温度下限（只读）")
            break
        case 7:  // 输入点选择（只读）
            console.log("✅ [PhaseAWindingTab] 输入点选择（只读）")
            break
        case 8:  // 过滤干扰延时（只读）
            console.log("✅ [PhaseAWindingTab] 过滤干扰延时（只读）")
            break
        }
    }
}
