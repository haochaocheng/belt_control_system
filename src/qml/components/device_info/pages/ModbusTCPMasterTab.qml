...
Rectangle {
    ...
    function handleDataViewKey(direction) {
        ...
        switch(direction) {
        case "Left":
            root.readMode = (root.readMode - 1 + 4) % 4
            return true
        case "Right":
            root.readMode = (root.readMode + 1) % 4
            return true
        case "Down":
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            border.color: root.focusSubArea === 2 && root.focusParamIndex >= 0 && root.readMode === index ? "#FF9800" : (root.readMode === index ? "#64B5F6" : "#4a5068")
                            border.width: root.focusSubArea === 2 && root.focusParamIndex >= 0 && root.readMode === index ? 3 : 1
