...
public:
    ...
    QList<RisipPhoneNumber *> phoneNumbersList; // Qt6: For QQmlListProperty
};
...
QQmlListProperty<RisipPhoneNumber> RisipPhoneContact::phoneNumbers()
{
    ...
    m_data->phoneNumbersList = m_data->phoneNumbers.values();
    return QQmlListProperty<RisipPhoneNumber>(this, &m_data->phoneNumbersList);
}
