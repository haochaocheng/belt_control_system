...
class RISIP_VOIPSDK_EXPORT QQmlSortFilterProxyModel : public QSortFilterProxyModel, public QQmlParserStatus
{
    Q_OBJECT
...
private:
    ...
    static qsizetype count_filter(QQmlListProperty<Filter>* list);  // Qt6: int -> qsizetype
    static Filter* at_filter(QQmlListProperty<Filter>* list, qsizetype index);  // Qt6: int -> qsizetype
    ...
    static qsizetype count_sorter(QQmlListProperty<Sorter>* list);  // Qt6: int -> qsizetype
    static Sorter* at_sorter(QQmlListProperty<Sorter>* list, qsizetype index);  // Qt6: int -> qsizetype
