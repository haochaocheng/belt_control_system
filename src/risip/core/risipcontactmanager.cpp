...
// Platform-specific contact access managers
#ifdef Q_OS_ANDROID
...
{
    // Qt6: QQmlListProperty expects a pointer to a member variable, not a temporary
    static QList<RisipBuddiesModel *> models;
    models = m_data->m_accountBuddyModels.values();
...
{
    // Qt6: QQmlListProperty expects a pointer to a member variable, not a temporary
    static QList<RisipContactHistoryModel *> models;
    models = m_data->m_accountContactHistoryModels.values();
...
{
    // Qt6: QQmlListProperty expects a pointer to a member variable, not a temporary
    static QList<RisipPhoneContact *> contacts;
    contacts = m_data->m_phoneContacts.values();
