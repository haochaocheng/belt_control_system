...
Q_IMPORT_QML_PLUGIN(Pidai1Plugin)
Q_IMPORT_QML_PLUGIN(Pidai1ContentPlugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_皮带机8Plugin)
Q_IMPORT_QML_PLUGIN(Generated_QtQuick3D_PD8Plugin)

const char mainQmlFile[] = "qrc:/qt/qml/Pidai1Content/App.qml";
